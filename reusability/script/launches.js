...
window.onscroll = function () {
    if (window.pageYOffset < 300) {
        ...
        document.getElementById('bar1').style.textShadow = '2px 2px 10px #9e9091df';
        document.getElementById('bar2').style.textShadow = '2px 2px 10px #9e9091df';
        document.getElementById('bar3').style.textShadow = '2px 2px 10px #9e9091df';
    } else {
        document.getElementById('topnav').style.background = '#0f0f0f';
        document.getElementById('menu-text').style.textShadow = 'none';
        document.getElementById('bar1').style.textShadow = 'none';
        document.getElementById('bar2').style.textShadow = 'none';
        document.getElementById('bar3').style.textShadow = 'none';
    }
}
...
async function getLaunches() {
    ...
    eachCard.setAttribute('div', 'launch-cards');
    eachCard2.setAttribute('div', 'launch-cards');
    eachCard3.setAttribute('div', 'launch-cards');
    ...
    eachCard.style.backgroundImage = 'linear-gradient(to top, #151515, #252525)';
    eachCard2.style.backgroundImage = 'linear-gradient(to top, #151515, #252525)';
    eachCard3.style.backgroundImage = 'linear-gradient(to top, #151515, #252525)';
    ...
    for (let obj in data) {
        ...
        emptyDetails.textContent = ('No details for this mission');
        ...
        video2.setAttribute('src', 'https://wallerweave.com/project-exam/videos/launches2-comp.mp4');
        ...
        emptyDetails2.textContent = ('No details for this mission');
        ...
        emptyDetails3.textContent = ('No details for this mission');
